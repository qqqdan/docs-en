...
# Migrate Data from CSV Files to TiDB {#migrate-data-from-csv-files-to-tidb}
...
## Step 4. Tune the import performance (optional) {#step-4-tune-the-import-performance-optional}
...
## Step 5. Import the data {#step-5-import-the-data}
