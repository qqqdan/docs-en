...
### Sysbench configuration {#sysbench-configuration}
...
### Warming data and collecting statistics {#warming-data-and-collecting-statistics}
...
### TiDB and TiKV are both properly configured under high concurrency, why is the overall performance still low? {#tidb-and-tikv-are-both-properly-configured-under-high-concurrency-why-is-the-overall-performance-still-low}
...
### Under high concurrency, why is the CPU utilization rate of TiKV still low? {#under-high-concurrency-why-is-the-cpu-utilization-rate-of-tikv-still-low}
...
### Given that TiKV has not yet reached the CPU usage bottleneck under high concurrency, why is TiDB's CPU utilization rate still low? {#given-that-tikv-has-not-yet-reached-the-cpu-usage-bottleneck-under-high-concurrency-why-is-tidb-s-cpu-utilization-rate-still-low}
