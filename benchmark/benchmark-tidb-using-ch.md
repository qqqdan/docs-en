...
# How to Run CH-benCHmark Test on TiDB {#how-to-run-ch-benchmark-test-on-tidb}
...
### Load TPC-C data {#load-tpc-c-data}
...
### Load additional tables and views required for TPC-H {#load-additional-tables-and-views-required-for-tpc-h}
