...
## MySQL-compatible comment syntax {#mysql-compatible-comment-syntax}
...
## TiDB specific comment syntax {#tidb-specific-comment-syntax}
...
## Optimizer comment syntax {#optimizer-comment-syntax}
