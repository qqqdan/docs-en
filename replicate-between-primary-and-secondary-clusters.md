...
# Replicate Data Between Primary and Secondary Clusters {#replicate-data-between-primary-and-secondary-clusters}
...
## Step 3. Migrate incremental data {#step-3-migrate-incremental-data}
...
## Step 4. Simulate a disaster in the upstream cluster {#step-4-simulate-a-disaster-in-the-upstream-cluster}
...
## Step 5. Use redo log to ensure data consistency {#step-5-use-redo-log-to-ensure-data-consistency}
...
## Step 6. Recover the primary cluster and its services {#step-6-recover-the-primary-cluster-and-its-services}
