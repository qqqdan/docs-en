...
### Grant a privilege to a role {#grant-a-privilege-to-a-role}
...
### Check a role's privileges {#check-a-role-s-privileges}
...
### Set the default role {#set-the-default-role}
...
### Enable a role in the current session {#enable-a-role-in-the-current-session}
...
### Check the current enabled role {#check-the-current-enabled-role}
