...
# App Development for the mysql-connector-python {#app-development-for-the-mysql-connector-python}
...
## Step 4. Get and run the application code {#step-4-get-and-run-the-application-code}
...
### Step 1. Update the connection parameters and connect to TiDB {#step-1-update-the-connection-parameters-and-connect-to-tidb}
...
### Step 2. Run the application code {#step-2-run-the-application-code}
