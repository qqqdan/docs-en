...
# Build a Simple CRUD App with TiDB and Python {#build-a-simple-crud-app-with-tidb-and-python}
...
### Step 3.1 Initialize table {#step-3-1-initialize-table}
...
### Step 3.2 Modify parameters for TiDB Cloud {#step-3-2-modify-parameters-for-tidb-cloud}
...
### Step 3.3 Run the code {#step-3-3-run-the-code}
...
## Step 4. Expected output {#step-4-expected-output}
