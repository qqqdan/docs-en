...
#### Step 1. Create a TiDB Cloud Serverless Tier cluster {#step-1-create-a-tidb-cloud-serverless-tier-cluster}
...
#### Step 1. Create a TiDB Cloud Dedicated Tier cluster {#step-1-create-a-tidb-cloud-dedicated-tier-cluster}
...
3.  Configure Proxy login users to make sure that the users have appropriate permissions on the TiDB cluster. In the following statements, you need to replace '*tidb cloud dedicated cluster username*' and '<em>tidb cloud dedicated cluster password</em>' with the actual username and password of your cluster.
