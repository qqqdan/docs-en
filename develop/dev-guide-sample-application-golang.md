...
# Build a Simple CRUD App with TiDB and Golang {#build-a-simple-crud-app-with-tidb-and-golang}
...
### Step 3.1 Table initialization {#step-3-1-table-initialization}
