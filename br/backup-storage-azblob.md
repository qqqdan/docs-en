...
# Back up and Restore Data on Azure Blob Storage Using BR {#back-up-and-restore-data-on-azure-blob-storage-using-br}
...
### Method 1: Back up and restore data using Azure AD (recommended) {#method-1-back-up-and-restore-data-using-azure-ad-recommended}
...
### Method 2: Back up and restore using an access key (easy) {#method-2-back-up-and-restore-using-an-access-key-easy}
