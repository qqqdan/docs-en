...
# Use BR to Back Up Cluster Data {#use-br-to-back-up-cluster-data}
...
### Encrypt backup data at the backup end {#encrypt-backup-data-at-the-backup-end}
...
### Encrypt backup data when backing up to Amazon S3 {#encrypt-backup-data-when-backing-up-to-amazon-s3}
...
## Validate backup data {#validate-backup-data}
...
### Check the integrity of backup data {#check-the-integrity-of-backup-data}
...
### Decode <code>backupmeta</code> to a readable JSON file {#decode-code-backupmeta-code-to-a-readable-json-file}
...
## Backup performance and impact {#backup-performance-and-impact}
