...
# Multiple Availability Zones in One Region Deployment {#multiple-availability-zones-in-one-region-deployment}
...
## Three AZs in one region deployment {#three-azs-in-one-region-deployment}
...
#### TiKV labels planning example {#tikv-labels-planning-example}
...
### High availability and disaster recovery analysis {#high-availability-and-disaster-recovery-analysis}
