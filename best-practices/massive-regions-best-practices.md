...
# Best Practices for TiKV Performance Tuning with Massive Regions {#best-practices-for-tikv-performance-tuning-with-massive-regions}
...
## Raftstore workflow {#raftstore-workflow}
...
## Performance tuning methods {#performance-tuning-methods}
...
### Method 1: Increase Raftstore concurrency {#method-1-increase-raftstore-concurrency}
...
### Method 3: Enable <code>Region Merge</code> {#method-3-enable-code-region-merge-code}
...
### Method 4: Increase the number of TiKV instances {#method-4-increase-the-number-of-tikv-instances}
...
### Method 5: Adjust <code>raft-base-tick-interval</code> {#method-5-adjust-code-raft-base-tick-interval-code}
...
### Method 6: Adjust Region size {#method-6-adjust-region-size}
...
## Other problems and solutions {#other-problems-and-solutions}

This section describes some other problems and solutions.

### Switching PD Leader is slow {#switching-pd-leader-is-slow}
...
### PD routing information is not updated in time {#pd-routing-information-is-not-updated-in-time}
...
### Prometheus is slow to query metrics {#prometheus-is-slow-to-query-metrics}
