...
# Introduction to Extended Statistics {#introduction-to-extended-statistics}
...
### Enable extended statistics {#enable-extended-statistics}
...
### Register extended statistics {#register-extended-statistics}
...
### Delete extended statistics {#delete-extended-statistics}
...
### Export and import extended statistics {#export-and-import-extended-statistics}
...
## Usage examples for correlation-type extended statistics {#usage-examples-for-correlation-type-extended-statistics}
...
### Step 2. Execute an example query without extended statistics {#step-2-execute-an-example-query-without-extended-statistics}
...
### Step 3. Enable extended statistics {#step-3-enable-extended-statistics}
...
### Step 4. See how extended statistics make a difference {#step-4-see-how-extended-statistics-make-a-difference}
