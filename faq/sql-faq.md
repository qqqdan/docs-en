...
## Can I use hints to override the optimizer behavior? {#can-i-use-hints-to-override-the-optimizer-behavior}
...
### How to scatter the hotspots? {#how-to-scatter-the-hotspots}
