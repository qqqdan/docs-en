...
## Performance tuning based on database time {#performance-tuning-based-on-database-time}
...
### Is TiDB the bottleneck? {#is-tidb-the-bottleneck}
...
### If the bottleneck is in TiDB, how to identify it? {#if-the-bottleneck-is-in-tidb-how-to-identify-it}
...
## Performance analysis and tuning using the Performance Overview dashboard {#performance-analysis-and-tuning-using-the-performance-overview-dashboard}
...
### Database time and SQL execution time overview {#database-time-and-sql-execution-time-overview}
...
### TiDB key metrics and cluster resource utilization {#tidb-key-metrics-and-cluster-resource-utilization}
...
#### KV/TSO Request OPS and connection information {#kv-tso-request-ops-and-connection-information}
...
#### TiDB CPU, TiKV CPU, and IO usage {#tidb-cpu-tikv-cpu-and-io-usage}
...
### Query latency breakdown and key latency metrics {#query-latency-breakdown-and-key-latency-metrics}
...
#### Duration and Connection Idle Duration {#duration-and-connection-idle-duration}
...
## If my TiDB version is earlier than v6.1.0, what should I do to use the Performance Overview dashboard? {#if-my-tidb-version-is-earlier-than-v6-1-0-what-should-i-do-to-use-the-performance-overview-dashboard}
