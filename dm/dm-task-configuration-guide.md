...
# Data Migration Task Configuration Guide {#data-migration-task-configuration-guide}

This document introduces how to configure a data migration task in Data Migration (DM).

## Configure data sources to be migrated {#configure-data-sources-to-be-migrated}
...
## Configure the downstream TiDB cluster {#configure-the-downstream-tidb-cluster}
...
## Configure tables to be migrated {#configure-tables-to-be-migrated}
...
## Configure binlog events to be migrated {#configure-binlog-events-to-be-migrated}
...
## Configure the mapping of data source tables to downstream TiDB tables {#configure-the-mapping-of-data-source-tables-to-downstream-tidb-tables}
...
## Configure a shard merge task {#configure-a-shard-merge-task}

> **Note:**
>
> -   If you need to migrate sharding DDL statements in a shard merge scenario, you **must** explicitly configure the `shard-mode` field. Otherwise, <strong>DO NOT</strong> configure `shard-mode` at all.
>
