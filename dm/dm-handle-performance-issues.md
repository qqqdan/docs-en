...
# Handle Performance Issues of TiDB Data Migration {#handle-performance-issues-of-tidb-data-migration}
...
### Read binlog data {#read-binlog-data}
...
### binlog data decoding and verification {#binlog-data-decoding-and-verification}
...
### Write relay log files {#write-relay-log-files}
...
## Binlog replication unit {#binlog-replication-unit}
...
### binlog event conversion {#binlog-event-conversion}
...
### Write SQL statements to downstream {#write-sql-statements-to-downstream}
