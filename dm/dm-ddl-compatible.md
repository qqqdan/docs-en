...
# Special Handling of DM DDLs {#special-handling-of-dm-ddls}
...
## Skip DDL statements {#skip-ddl-statements}
...
## Rewrite DDL statements {#rewrite-ddl-statements}
...
## Shard merge migration tasks {#shard-merge-migration-tasks}
