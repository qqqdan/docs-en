...
# Handle Failed DDL Statements in TiDB Data Migration {#handle-failed-ddl-statements-in-tidb-data-migration}
...
### Skip DDL if the migration gets interrupted {#skip-ddl-if-the-migration-gets-interrupted}
...
#### Non-shard-merge scenario {#non-shard-merge-scenario}
...
#### Shard merge scenario {#shard-merge-scenario}
...
### Replace DDL if the migration gets interrupted {#replace-ddl-if-the-migration-gets-interrupted}
