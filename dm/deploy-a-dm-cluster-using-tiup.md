...
## Step 6: Start the DM cluster {#step-6-start-the-dm-cluster}
...
## Step 7: Verify the running status of the DM cluster {#step-7-verify-the-running-status-of-the-dm-cluster}
