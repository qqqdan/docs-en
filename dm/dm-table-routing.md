...
### Extract table, schema, and source information and write into the merged table {#extract-table-schema-and-source-information-and-write-into-the-merged-table}
