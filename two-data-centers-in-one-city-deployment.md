...
# Two Availability Zones in One Region Deployment {#two-availability-zones-in-one-region-deployment}
...
### Enable the DR Auto-Sync mode {#enable-the-dr-auto-sync-mode}
