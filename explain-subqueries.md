...
# Explain Statements That Use Subqueries {#explain-statements-that-use-subqueries}
...
## Inner join (non-unique subquery) {#inner-join-non-unique-subquery}
...
## Inner join (unique subquery) {#inner-join-unique-subquery}
...
## Semi join (correlated subquery) {#semi-join-correlated-subquery}
...
## Anti semi join (<code>NOT IN</code> subquery) {#anti-semi-join-code-not-in-code-subquery}
