...
# TiDB Lightning Requirements for the Target Database {#tidb-lightning-requirements-for-the-target-database}
...
## Privileges of the target database {#privileges-of-the-target-database}
...
## Storage space of the target database {#storage-space-of-the-target-database}
