...
Based on a successful test data import, this document explains log messages of **TiDB Lightning v5.4** with <strong>Local Backend mode</strong>, and dives deep to understand where the log comes from and what it actually represents. You can refer to this doc to better understand TiDB Lightning logs.
