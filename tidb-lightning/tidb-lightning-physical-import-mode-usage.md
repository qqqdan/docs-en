...
# Use Physical Import Mode {#use-physical-import-mode}
...
## Configure and use the physical import mode {#configure-and-use-the-physical-import-mode}
...
-   **Use the <a href="/tidb-lightning/tidb-lightning-distributed-import.md">parallel import</a> feature to achieve horizontal scaling.**
