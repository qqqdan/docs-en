...
## Usage scenarios of partition pruning {#usage-scenarios-of-partition-pruning}
...
### Use partition pruning in Hash partitioned tables {#use-partition-pruning-in-hash-partitioned-tables}

This section describes the applicable and inapplicable usage scenarios of partition pruning in Hash partitioned tables.

#### Applicable scenario in Hash partitioned tables {#applicable-scenario-in-hash-partitioned-tables}
...
#### Inapplicable scenarios in Hash partitioned tables {#inapplicable-scenarios-in-hash-partitioned-tables}
...
### Use partition pruning in Range partitioned tables {#use-partition-pruning-in-range-partitioned-tables}

This section describes the applicable and inapplicable usage scenarios of partition pruning in Range partitioned tables.

#### Applicable scenarios in Range partitioned tables {#applicable-scenarios-in-range-partitioned-tables}
...
#### Inapplicable scenario in Range partitioned tables {#inapplicable-scenario-in-range-partitioned-tables}
