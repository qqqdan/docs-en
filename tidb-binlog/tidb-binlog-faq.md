...
## How to restore the data of a cluster using a full backup and a binlog backup file? {#how-to-restore-the-data-of-a-cluster-using-a-full-backup-and-a-binlog-backup-file}
