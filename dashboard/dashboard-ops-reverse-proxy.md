...
# Use TiDB Dashboard behind a Reverse Proxy {#use-tidb-dashboard-behind-a-reverse-proxy}

You can use a reverse proxy to safely expose the TiDB Dashboard service from the internal network to the external.

## Procedures {#procedures}

### Step 1: Get the actual TiDB Dashboard address {#step-1-get-the-actual-tidb-dashboard-address}
...
### Step 2: Configure the reverse proxy {#step-2-configure-the-reverse-proxy}
...
## Customize path prefix {#customize-path-prefix}
...
### Step 1: Modify PD configuration to specify the path prefix of TiDB Dashboard service {#step-1-modify-pd-configuration-to-specify-the-path-prefix-of-tidb-dashboard-service}
...
### Step 2: Modify the reverse proxy configuration {#step-2-modify-the-reverse-proxy-configuration}
