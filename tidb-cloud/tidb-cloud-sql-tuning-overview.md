...
### Use Statement on the Diagnosis tab {#use-statement-on-the-diagnosis-tab}

The TiDB Cloud console provides a **<a href="/tidb-cloud/tune-performance.md#statement-analysis">Statement</a>** sub-tab on the <strong>Diagnosis</strong> tab. It collects the execution statistics of SQL statements of all databases on the cluster. You can use it to identify and analyze SQL statements that consume a long time in total or in a single execution.
