...
The term *clustered* in this context refers to the <em>organization of how data is stored</em> and not <em>a group of database servers working together</em>. Some database management systems refer to clustered indexes as <em>index-organized tables</em> (IOT).
